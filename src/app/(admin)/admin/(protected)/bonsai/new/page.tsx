...
//         throw new Error(
//           validationErrors || data.message || "Failed to create Bonsai.",
//         );
//       }

//       alert("Bonsai created successfully.");
...
//       {/* HEADER */}
//       <div className="mb-6">
//         <h1 className="text-2xl font-bold">Add Bonsai</h1>

//         <p className="text-sm text-gray-500 mt-1">
//           Add a Bonsai to the Earthvine collection.
//         </p>
//       </div>
...
//                 placeholder="Describe this Bonsai..."
//                 rows={7}
//                 className="border p-2 w-full rounded"
//               />
//             </div>
...
//             Upload multiple images. The first image will be used as the primary
//             image.
//           </p>
...
//                 placeholder="Water when top soil is dry"
//                 className="border p-2 w-full rounded"
//               />
//             </div>
//           </div>
...
export default function NewBonsaiPage() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    if (form.images.length < 1) {
      alert("Please upload at least one bonsai image.");
      return;
    }
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/admin/bonsai`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      if (!response.ok) {
        throw new Error(data?.message || "Failed to create bonsai.");
      }
      ...
      alert(
        error instanceof Error ? error.message : "Failed to create bonsai.",
      );
    } finally {
      setSaving(false);
    }
  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900">Add Bonsai</h1>

        <p className="text-sm text-gray-500 mt-1">
          Create a new bonsai product.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-6">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-300"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.potInfo}
                    onChange={(e) => updateField("potInfo", e.target.value)}
                    placeholder="Ceramic bonsai pot"
                    className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm outline-none focus:border-gray-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.watering}
                    onChange={(e) => updateField("watering", e.target.value)}
                    placeholder="Water when top soil dries"
                    className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm outline-none focus:border-gray-500"
                  />
                </div>
              </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ficus Bonsai | Earthvine Interiors"
                    required
                    className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm outline-none focus:border-gray-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Discover our carefully selected Ficus Bonsai..."
                    required
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              >
                {saving ? "Creating Bonsai..." : "Create Bonsai"}
              </button>
