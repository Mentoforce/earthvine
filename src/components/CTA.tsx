...
const CTASection = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden section-padding bg-[hsl(var(--charcoal))]"
    >
      ...
      <div className="relative z-10 max-w-225 mx-auto text-center">
        ...
        >
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link
              href="/quotation"
              className="px-6 sm:px-10 py-3 sm:py-4 bg-[hsl(var(--gold))] text-[hsl(var(--charcoal))] font-semibold text-[11px] sm:text-[13px] tracking-wider uppercase transition-all duration-500 hover:bg-[hsl(var(--cream))]"
            >
              Get Free Quotation
            </Link>
            ...
            <Link
              href="/contact"
              className="px-6 sm:px-10 py-3 sm:py-4 border border-[hsl(var(--cream)/0.2)] text-[hsl(var(--cream))] text-[11px] sm:text-[13px] tracking-wider uppercase transition-all duration-500 hover:border-[hsl(var(--gold))] hover:text-[hsl(var(--gold))]"
            >
              Book Appointment
            </Link>
          </div>
